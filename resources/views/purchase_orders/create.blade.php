...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <form class="form-horizontal" action="{{ route('purchase_orders.store') }}" method="POST">
                {{ csrf_field() }}
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Tambah Pengadaan</h3>
                    </div>
                    ...
                    <div class="panel-footer clearfix">
                        ...
                        <a href="{{ route('purchase_orders.index') }}" class="btn btn-default">Batal</a>
                    </div>
                </div>
            </form>
        </div>
